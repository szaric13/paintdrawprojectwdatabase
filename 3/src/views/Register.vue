    ...
    <form @submit.prevent="submitRegister" class="auth-form">
      ...
      <div class="input-group">
        ...
        <input
          ...
          required
        />
        <span v-if="confirmPassword && confirmPassword !== password" class="error">Passwords must match.</span>
      </div>
      <button type="submit" class="auth-button" :disabled="!isFormValid">Register</button>
    </form>
  ...
  setup() {
    ...
    const submitRegister = async () => {
      try {
        ...
        errorMessage.value = authStore.errorMessage || 'An unexpected error occurred. Please try again.';
      }
    };
